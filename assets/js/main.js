...
/*------------------------------------------
 Email Verification Realtime
 ------------------------------------------*/
function isValidEmail(){
    var email = $("#email").val();
    if (email.indexOf("@") > -1 && email.indexOf(".") > email.indexOf("@")){
        $("#email").css("background", "#C7FFC7");
    }
    else {
        $("#email").css("background", "#FFC7C7");
    }
...
function checkFieldsMatch(){
    var email = $("#email").val();
    var emailConfirm = $("#emailV").val();
    if (email == emailConfirm){
        $("#emailV").css("background", "#C7FFC7");
    }
    else {
        $("#emailV").css("background", "#FFC7C7");
    }
}
/*------------------------------------------
 Fun-facts counter
